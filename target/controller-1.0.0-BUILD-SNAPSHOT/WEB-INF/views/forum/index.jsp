      ...
      <div class="row">
        <div class="header">
          <div class="header_menu">
            <a href="/resources/main/html/loginForm.html">로그인</a>
            <a href="#">회원가입</a>
      ...
      <div class="container">
        ...
        <section id="cont_left">
          ...
          <article class="column col3">
            ...
            <div class="blog1">
              ...
              <figure>
                <img src="/resources/main/img/blog4_@1.jpg" class="img-normal" alt="normal image">
                <img src="/resources/main/img/blog4_@2.jpg" class="img-retina" alt="retina image">
        ...
        <section id="cont_center">
          ...
          <article class="column col4">
            ...
            <div class="slider">
              <div>
                <figure>
                  <img src="/resources/main/img/slider001.jpg" alt="이미지1">
                  <figcaption><em>Responsive Site</em><span>슬라이드 플러그인을 이용한 반응형 이미지 슬라이드 입니다.</span></figcaption>
                </figure>
              </div>
              <div>
                <figure>
                  <img src="/resources/main/img/slider001.jpg" alt="이미지2">
                  <figcaption><em>Responsive Site</em><span>슬라이드 플러그인을 이용한 반응형 이미지 슬라이드 입니다.</span></figcaption>
                </figure>
              </div>
              <div>
                <figure>
                  <img src="/resources/main/img/slider001.jpg" alt="이미지3">
                  <figcaption><em>Responsive Site</em><span>슬라이드 플러그인을 이용한 반응형 이미지 슬라이드 입니다.</span></figcaption>
                </figure>
              </div>
            </div>
          ...
          <article class="column col5">
            ...
            <div class="lightbox square clearfix">
              <a href="/resources/main/img/light01_s.jpg"><img src="/resources/main/img/light01.jpg" alt="이미지"><em>blur</em></a>
              <a href="/resources/main/img/light02_s.jpg"><img src="/resources/main/img/light02.jpg" alt="이미지"><em>brightness</em></a>
              <a href="/resources/main/img/light03_s.jpg"><img src="/resources/main/img/light03.jpg" alt="이미지"><em>contrast</em></a>
              <a href="/resources/main/img/light04_s.jpg"><img src="/resources/main/img/light04.jpg" alt="이미지"><em>grayscale</em></a>
              <a href="/resources/main/img/light05_s.jpg"><img src="/resources/main/img/light05.jpg" alt="이미지"><em>hue-rotate</em></a>
              <a href="/resources/main/img/light06_s.jpg"><img src="/resources/main/img/light06.jpg" alt="이미지"><em>invert</em></a>
              <a href="/resources/main/img/light07_s.jpg"><img src="/resources/main/img/light07.jpg" alt="이미지"><em>opacity</em></a>
              <a href="/resources/main/img/light08_s.jpg"><img src="/resources/main/img/light08.jpg" alt="이미지"><em>saturate</em></a>
              <a href="/resources/main/img/light09_s.jpg"><img src="/resources/main/img/light09.jpg" alt="이미지"><em>sepia</em></a>
              <a href="/resources/main/img/light10_s.jpg"><img src="/resources/main/img/light10.jpg" alt="이미지"><em>Mix</em></a>
            </div>
            <!--//lightbox -->
          </article>
          <!-- //col5 -->
        ...
        <section id="cont_right">
          ...
          <article class="column col7">
            ...
            <div class="side1">
              <figure class="front">
                <img src="/resources/main/img/side1.jpg" alt="이미지2">
              </figure>
              <div class="back">
          ...
          <article class="column col8">
            ...
            <div class="side2">
              <figure class="front">
                <img src="/resources/main/img/side2.jpg" alt="이미지2">
                <figcaption>
                  <h3>Hover Effect</h3>
                </figcaption>
              </figure>
              <figure class="back">
                <img src="/resources/main/img/side4.jpg" alt="이미지2">
                <figcaption>
                  <h3>Hover Effect</h3>
                </figcaption>
              </figure>
          ...
          <article class="column col9">
            ...
            <div class="side3">
              <figure>
                <img src="/resources/main/img/side3.jpg" alt="이미지3">
                <figcaption>
