				...
				<form role="form" action="/wish/modify" method="post">
					...
					<table id='app_table'>
						...
						<tr>
							...
							<td colspan="3"><textarea rows='3' name='comments' cols="50"><c:out
					...
					<button type="submit" data-oper='modify' class="btn btn-default yun_btn">
						수정</button>
					<button type="submit" data-oper='remove' class="btn btn-danger yun_btn">
						삭제</button>
					<%-- </c:if>		
					</sec:authorize> --%>

					<button type="submit" data-oper='list' class="btn btn-info yun_btn">
						목록</button>
				</form>
			</div>
			<!-- /.panel-body -->
