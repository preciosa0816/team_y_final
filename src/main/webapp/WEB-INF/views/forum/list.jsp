...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<button id='regBtn' type='button' class="btn btn-default yun_btn">게시글 쓰기</button>
			</sec:authorize>
			</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
					...
					<c:forEach items="${list}" var="forum">
						<tr>
							...
							<td><a class='move'
								...
								<c:out value="${forum.title }" /> <b>[<c:out value="${forum.reply_Cnt }"/>]</b>
										</a></td>
				...
				<form id='searchForm' action="/forum/list" method="get">
					...
					<button class='btn btn-default yun_btn2'>검색</button>
					</form>	
				</div>			
				</div>
