		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" action="/mypage/wishlistmodify" method="post">
					...
					<table id='app_table'>
						<tr>
							<td width="70px;"><label>신청번호</label></td>
							<td width="10%;"><input name="wno" width="500px"
								value='<c:out value="${wishlist.wno}"/>' readonly="readonly"></td>
							<td width="70px;"><label>신청일</label></td>
							<td width="10%;"><input name="regDate" width="500px"
								value='<fmt:formatDate pattern="yyyy-MM-dd hh:mm"
									value="${wishlist.regdate }" />'
								readonly="readonly"></td>
						</tr>
						<tr>
							<td width="70px;"><label>도서형태</label></td>
							<td width="10%;"><select name="book_type">
							...
							<td width="70px;"><label>도서명</label></td>
							<td width="10%;"><input name="title" width="500px"
								value='<c:out value="${wishlist.title}"/>'><button class='yun_btn' type="button" value="도서 검색" >도서검색</button></td>
						</tr>
						<tr>
							<td width="70px;"><label>저자</label></td>
							<td width="10%;"><input name="author" width="500px"
								value='<c:out value="${wishlist.author}"/>'></td>
							<td width="70px;"><label>출판사</label></td>
							<td width="10%;"><input name="publisher" width="500px"
								value='<c:out value="${wishlist.publisher}"/>'></td>
						</tr>
						<tr>
							<td width="70px;"><label>발행일</label></td>
							<td width="10%;"><input name="pubyear" width="500px"
								value='<fmt:formatDate pattern="yyyy/MM/dd"
									value="${wishlist.pubyear }" />'></td>

							<td width="70px;"><label>ISBN</label></td>
							<td width="10%;"><input name="ISBN" width="500px"
								value='<c:out value="${wishlist.ISBN}"/>'></td>
						</tr>
						<tr>
							<td width="70px;"><label>비고</label></td>
							<td colspan="3"><textarea rows='3' name='comments' cols="65"><c:out
										value="${wishlist.comments}" /></textarea></td>
						</tr>
						<tr>
							<td width="70px;"><label>처리결과</label></td>
					...
					<button type="submit" id='modify' data-oper='modify' class="btn btn-default yun_btn2">
						수정</button>
					<button type="submit" data-oper='cancle' class="btn btn-danger yun_btn2">
						신청취소</button>
					<%-- </c:if>		
					</sec:authorize> --%>

					<button type="submit" data-oper='list' class="btn btn-info yun_btn2">
						목록</button>
				</form>
			</div>
			<!-- /.panel-body -->
