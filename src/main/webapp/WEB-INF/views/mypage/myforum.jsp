...
<div class="navbars">
    ...
    <button class="dropbtns active" style='width:120px; background-color:#4CAF50; color:white;'>내가 쓴 글 
...
<div class="panel-body">
	<table width="100%"
		...
		<c:forEach items="${list}" var="forum">
						<tr>
							...
							<td><a class='move' href='<c:out value="${forum.bno}"/>'>
									<c:out value="${forum.title }" /> 
									<b>[<c:out
											value="${forum.reply_Cnt }" />]
								</b></a></td>
	...
	<div class="row">
				...
				<form id='searchForm' action="/mypage/myforum" method="get">
					...
					<button class='btn btn-default yun_btn2'>Search</button>
					</form>	
				</div>			
				</div>
