...
<div class="navbars">
	<sec:authentication property="principal" var="pinfo" />
	<a href="/mypage/myinfo">회원정보</a> <a href="#news">예약도서현황</a> <a
		class='active'
		href="/mypage/wishlist?user_id=<c:out value="${pinfo.username}"/>">희망도서현황</a>
	<div class="dropdowns" style='width:30%;'>
    <button class="dropbtns" style='width:120px;'>내가 쓴 글 
		...
		<c:forEach items="${list}" var="wishlist">
			<tr>
				...
				<td><c:if test="${wishlist.progress eq '신청대기중'}">
						<button type='button' data-oper='modify' class="yun_btn"
	...
	<div class="row">
		<div class="col-lg-12">
			<form id='searchForm' action="/mypage/wishlist" method="get">
				...
				<button class='yun_btn2'>Search</button>
			</form>
		</div>
	</div>
